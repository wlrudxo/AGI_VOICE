...
type LayoutRouteId = RouteId | "/" | "/ai-settings" | "/ai-settings/characters" | "/ai-settings/chat-settings" | "/ai-settings/commands" | "/ai-settings/final-message" | "/ai-settings/system-messages" | "/ai-settings/user-info" | "/app-settings" | "/autonomous-driving" | "/autonomous-driving/manual-control" | "/autonomous-driving/settings" | "/autonomous-driving/triggers" | "/autonomous-driving/vehicle-control" | "/map-settings" | "/map-settings/generator" | "/map-settings/library" | "/map-settings/rag-test" | null
