...
lines = {
    ...
    sprintf('- violation count: `%d`', summary.objective.NViolation)
...
JContinuous = ...
    ...
    0.30 * MAX_r / 0.80 + ...
    5.00 * NViolation + ...
    20.0 * double(crashOrSimFail);

if crashOrSimFail
    JFailClosed = 50 + 10 * NViolation;
...
objective.NViolation = NViolation;
