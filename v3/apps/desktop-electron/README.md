# AGI Voice Desktop Shell

Electron shell for the active V3 workspace.

## Assumptions

- Frontend dev server runs at `http://127.0.0.1:4173`
...
- `npm run dev` expects the active V3 frontend workspace.
...
- Tray and window icons are stored locally under `assets/`.
