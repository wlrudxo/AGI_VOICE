<script>
  ...
  import { carmakerStore } from './lib/stores/carmakerStore.svelte.js';
  import { triggerMonitor } from './lib/stores/triggerMonitor.svelte.js';
  import { dialogStore } from './lib/stores/dialogStore.svelte.js';
...
<svelte:head>
  <title>AGI Voice V3 Vehicle Control</title>
  <meta
    name="description"
    content="V3 vehicle control surface backed by the Python CarMaker API."
  />
</svelte:head>

<div class="shell vehicle-control-shell">
