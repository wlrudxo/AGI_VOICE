...
<div class="max-w-4xl mx-auto">
  ...
  {:else}
    ...
    <div class="card rounded-lg p-6 shadow-md mb-6">
      <h2 class="text-xl font-bold mb-4 text-primary">창 설정</h2>
    ...
    <!-- Database Settings -->
    <div class="card rounded-lg p-6 shadow-md mb-6">
      <h2 class="text-xl font-bold mb-4 text-primary">데이터베이스 설정</h2>
    ...
    <!-- Database Management -->
    <div class="card rounded-lg p-6 shadow-md mb-6">
      <h2 class="text-xl font-bold mb-4 text-primary">데이터베이스 관리</h2>

      {#if dbMessage}
        <div
          class="px-4 py-3 rounded-lg mb-4"
          style="background-color: {dbMessage.type === 'success' ? 'var(--color-success)' : 'var(--color-error)'}; color: white;"
        >
          {dbMessage.text}
        </div>
      {/if}
      ...
      {:else if dbInfo}
        <!-- DB Info -->
        <div class="mb-6 p-4 rounded-lg" style="background-color: var(--color-background);">
    ...
    <div class="card rounded-lg p-6 shadow-md">
      <h2 class="text-xl font-bold mb-4 text-primary">AI 채팅 설정</h2>
      ...
      <form onsubmit={(e) => { e.preventDefault(); saveSettings(); }} class="space-y-6">
        ...
        <div>
          ...
          <select
            ...
            class="w-full px-4 py-3 rounded-lg border border-default"
          >
        ...
        {#if message}
          <div
            ...
            style="background-color: {message.type === 'success' ? 'var(--color-success)' : 'var(--color-error)'}; color: white;"
          >
            {message.text}
          </div>
        {/if}
    ...
    <!-- Info Card -->
    <div class="mt-6 card rounded-lg p-6 shadow-md">
      <h3 class="text-lg font-bold mb-3 text-primary">💡 설정 안내</h3>
